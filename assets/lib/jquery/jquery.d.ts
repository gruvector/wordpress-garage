...
interface JQueryAnimationOptions {
    ...
    complete?: Function;
    /**
     * A function to be called for each animated property of each animated element. This function provides an opportunify to modify the Tween object to change the value of the property before it is set.
     */
