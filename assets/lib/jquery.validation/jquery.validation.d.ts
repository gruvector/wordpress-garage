...
declare module JQueryValidation
{
    ...
    interface ValidatorStatic
    {
         ...
         */
        addMethod(name: string, method: (value: any, element: HTMLElement, params: any) => boolean, message?: string | Function): void;
        /**
    ...
    interface Validator
    {
         ...
         */
        resetForm(): void;
        resetElements(elements: JQuery): void;
        ...
        errorsFor(element: HTMLElement): JQuery;
    }
}
